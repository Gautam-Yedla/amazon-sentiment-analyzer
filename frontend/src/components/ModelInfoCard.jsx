...
//       <button onClick={() => setIsOpen(!isOpen)} className={`flex items-center space-x-1 text-sm hover:underline ${darkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'}`}>
//         <Info size={14} />
//         <span>Model Info</span>
//       </button>
//       {isOpen && (
//         <div className={`absolute bottom-full right-0 mb-2 p-4 rounded-lg shadow-lg border max-w-xs ${darkMode ? 'bg-gray-900 border-gray-800 text-gray-300' : 'bg-white border-gray-200 text-gray-700'}`}>
//           <div className="space-y-2">
//             <h4 className="font-medium">Sentiment Analysis Model</h4>
//             <p className="text-sm">Uses a machine learning model trained on Amazon product reviews to classify sentiment as Positive, Negative, or Neutral.</p>
//             <p className="text-sm"><strong>Accuracy:</strong> ~85%<br /><strong>Training Data:</strong> 50K+ reviews<br /><strong>Model Type:</strong> FastText</p>
//           </div>
//         </div>
//       )}
//     </div>
